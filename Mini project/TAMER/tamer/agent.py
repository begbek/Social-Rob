...
class Tamer:
    ...
    def __init__(
        ...
        tame=False,  # set to false for normal Q-learning
    ...
    def _train_episode(self, episode_index, disp):
        ...
        with open(self.reward_log_path, 'a+', newline='') as write_obj:
            ...
            for ts in count():
                ...
                XXX = self.env.step(action)
                next_state, reward, done, info = XXX[0], XXX[1], XXX[2], XXX[3]
                ...
                tot_reward += reward
                print(f'Reward : {reward}, TotReward : {tot_reward}')
                if done:
